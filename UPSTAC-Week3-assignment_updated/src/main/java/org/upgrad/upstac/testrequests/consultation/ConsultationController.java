...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User loggedinDoc = userLoggedInService.getLoggedInUser();
            return testRequestUpdateService.assignForConsultation(id, loggedinDoc);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            // replace this line of code with your implementation
            User loggedinDoct = userLoggedInService.getLoggedInUser();
            return testRequestUpdateService.updateConsultation(id,testResult,loggedinDoct);
